...
print_help () {
    ...
    printf "\033[33mWARINNIG: THIS SCRIPT CAN BE DESTRUCTIVE, IN FILE SUCH AS IMAGES, ETC, IT WILL CORRUPT\n"
    printf "THEM IF RUNNING RECURSIVELY CARELESSLY.\033[0m\n\n"
    printf "Option:\n"
